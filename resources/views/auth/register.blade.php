                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('auth.register') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" aria-describedby="textHelp">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="No WhatsApp" name="no_wa" aria-describedby="textHelp">
                                    </div>
                                    <div class="mb-4">
