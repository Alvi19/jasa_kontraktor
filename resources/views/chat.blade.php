                    ...
                    <div class="card-body border">
                        <div class="container-fluid mt-2">
                            ...
                            <nav class="" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="font-italic"><a href="{{ route('data_client.index') }}">Data Client</a>
                                    </li>
                            ...
                            {{-- </div> --}}
                            {{-- <hr class="my-2"> --}}
                            <a href="{{ route('data_client.index') }}" class="btn btn-md btn-primary mx-2 mt-2 "><i
                                    class="ti ti-arrow-back-up mt-5">
                                    kembali</i></a>
