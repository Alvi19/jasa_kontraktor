                ...
                <div class="card-body border">
                    ...
                    <form action="{{ route('jasa.update', [$data->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control form-control-sm" name="foto_kontraktor" id="foto_kontraktor" value="{{ $data->file }}">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama <span class="text-danger">*<span></label>
                            <input class="form-control summernote" type="text" name="nama" placeholder="Nama" value="{{ $data->nama }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="nama_pembangunan" class="form-label">Nama Pembangunan <span class="text-danger">*<span></label>
                            <input class="form-control summernote" type="text" name="nama_pembangunan" placeholder="Nama Pembangunan" value="{{ old('nama_pembangunan') ?? $data->nama_pembangunan }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat <span class="text-danger">*<span></label>
                            <input class="form-control summernote" id="alamat" type="text" name="alamat" placeholder="Alamat" value="{{ $data->alamat }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="jumlah_tukang" class="form-label">Jumlah Tukang <span class="text-danger">*<span></label>
                            <input class="form-control summernote" id="jumlah_tukang" type="number" name="jumlah_tukang" placeholder="Jumlah Tukang" value="{{ $data->jumlah_tukang }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="riwayat_pembangunan" class="form-label">Riwayat Pembangunan <span class="text-danger">*<span></label>
                            <textarea class="form-control summernote" rows="8" id="riwayat_pembangunan" name="riwayat_pembangunan" placeholder="Riwayat Pembangunan">{{ $data->riwayat_pembangunan }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="foto_pembangunan" class="form-grup">Foto Pembangunan</label>
                            <input type="file" class="form-control form-control-sm" name="foto_pembangunan" id="foto_pembangunan" value="{{ $data->foto_pembangunan }}">
                        </div>
                        <div class="mb-3">
