                ...
                <div class="table-responsive border-bottom-dark">
                    <div class="row align-items-start text-center mx-2" style="">
                        <div class="container px-4">
                            <div class="row gx-5">
                                <div class="col-3">
                                    <img src="{{ '/upload/' . $kontraktors->foto_kontraktor }}" style="height: 150px ; width:200px" class="float-left" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body text-lg-start">
                                        ...
                                        <div class="col">
                                            <a class="btn btn-md btn-primary ti ti-message-2" href="{{ route('chat.show', ['id' => $kontraktors->id]) }}"> Chat</a>
                        ...
                        <div class="card mt-5">
                            ...
                            <div class="card-body text-lg-start">
                                <blockquote class="blockquote mb-0">
                                    <img src="{{ '/upload/' . $kontraktors->foto_pembangunan }}" style="height: 150px ; width:200px" class="float-left" alt="foto_pembangunan">
