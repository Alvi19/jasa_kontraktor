                ...
                <div class="card-body border">
                    ...
                    <form action="{{ route('form.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" id="luas_bangunan" type="number" name="luas_bangunan"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" id="jumlah_tukang" type="number" name="jumlah_tukang"
                                placeholder="Jumlah Tukang" value="{{ old('jumlah_tukang') }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control summernote" id="keterangan_ruangan" rows="8"
                                name="keterangan_ruangan"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control summernote" id="catatan" rows="8" name="catatan"
