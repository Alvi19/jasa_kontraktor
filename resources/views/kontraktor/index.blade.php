                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kontraktor.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" type="text" name="username" placeholder="Username" value="{{ old('username') ?? @$data->user->username }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" type="text" name="nama_lengkap" placeholder="Nama" value="{{ old('nama_lengkap') ?? @$data->user->nama_lengkap }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" type="number" name="no_wa" placeholder="Whatsapp" value="{{ old('whatsApp') ?? @$data->user->no_wa }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" type="number" name="jumlah_tukang" placeholder="Jumlah Tukang" value="{{ old('jumlah_tukang') ?? @$data->jumlah_tukang }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control summernote" name="nama_bank" placeholder="Contoh: BCA" value="{{ old('nama_bank') ?? @$data->nama_bank }}">
                        </div>
                        <div class="mb-3">
                            <label for="no_wa" class="form-label">No. Rekening</label>
                            <input class="form-control summernote" type="number" name="rekening" placeholder="Contoh: 123xxxxx" value="{{ old('rekening') ?? @$data->rekening }}">
                        </div>
