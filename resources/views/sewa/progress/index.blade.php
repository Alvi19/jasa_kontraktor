        ...
        <div class="col-md-12 mt-2">
            ...
            <div class="pd-5">
                ...
                <a href="{{ route('data_client.index') }}" class="btn btn-md btn-outline-primary mx-2 mt-2 "><i
                        ...
                        kembali</i></a>
                <a href="{{ route('data_client.progress.create', $id) }}" class="btn btn-md btn-primary mx-2 mt-2"><i
                        class="ti ti-clipboard-plus">
                        Create Progress</i></a>
                @endif
                ...
                <table class="table table-bordered table-stripped table-hover mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if (auth()->user()->status == 'kontraktor')
                            <td>
                                <a href="{{ route('data_client.progress.edit', [$id, $item->id]) }}"
                                ...
                                <button class="btn btn-md btn-danger" data-bs-toggle="modal"
                                    ...
                                    data-delete-url="{{ route('data_client.progress.destroy', [$id, $item->id]) }}"><i
